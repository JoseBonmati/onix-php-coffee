document.addEventListener("DOMContentLoaded", () => {
    ...
    // DOM references
    const calMonthYear = document.getElementById("cal_month_year");
    ...
    // Exit if there is no calendar on the current page to prevent console errors
    ...
    function createCalendarTable() {
        ...
        for (let day = 1; day <= daysInMonth; day++) {
            ...
            cell.addEventListener("click", () => selectDay(cell, dateStr));
