    ...
    <header class="sticky-top">
        <nav class="navbar navbar-expand-lg container-fluid">
            <a class="navbar-brand ms-3" href="/index.php">
                <img src="/assets/brand/logo-pequenyo.png" alt="Logo" width="auto" height="auto" style="max-height: 60px;">
            </a>
            ...
            <div id="navPrincipal" class="collapse navbar-collapse">
                <ul class="navbar-nav ms-auto align-items-center fs-4 fw-semibold gap-lg-4">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/menu.php">Carta</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item me-lg-3">
                        <?php if (isset($_SESSION["id"])): ?>
                            <a href="/users/profile.php" class="nav-link">
                                <img src="/assets/brand/perfil.png" alt="Perfil" class="rounded-circle" width="48" height="48">
                            </a>
                        <?php else: ?>
                    ...
                    <?php if (isset($_SESSION["role"]) && $_SESSION["role"] === "admin"): ?>
                        <li class="nav-item">
                            <a class="btn btn-onix fw-semibold me-lg-4 my-2 my-lg-0" href="/utils/admin_panel.php">Panel de Administración</a>
                        </li>
                    <?php endif; ?>
                </ul>
            </div>
